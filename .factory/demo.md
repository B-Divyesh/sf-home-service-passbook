...
Open `/?demo=1` or <https://home-service-passbook.sociobot.in/?demo=1>. The `/demo` route is an equivalent shareable address.
...
The banner stays visible while demo mode is active. **Reset demo** restores the bundled records. **Start for real** opens the separate household passbook without changing it.
